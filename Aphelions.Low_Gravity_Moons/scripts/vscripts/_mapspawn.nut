...
//=========================================================
	...
	{
		ServerCommand( "sv_gravity 600" ) // Lower gravity for moon-based maps
		ServerCommand( "superjump_max_height 100" )
	}
	else if ( mapname == "mp_outpost_207" )
	{
		ServerCommand( "sv_gravity 450" )  // The smaller the moon, the less gravity there is
		ServerCommand( "superjump_max_height 120" )
	}
	else if ( mapname == "mp_sandtrap" )
	{
		ServerCommand( "sv_gravity 300" ) 
		ServerCommand( "superjump_max_height 140" )
	}
	else
	{
