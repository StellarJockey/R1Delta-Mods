...
-
The list is quite extensive, so look at the WEAPON\_CHANGES.txt file. It's mostly weapon buffs for those that needed it, as well as some FO-exclusive mods. All npc weapons will now do the same damage as player weapons. These FO-exclusive weapon mods will not carry over into regular MP matches, so don't worry about that.

*Just don't use the Titan Minigun in MP. It hasn't been fixed in base R1 yet!*
