...
function MapButton_Focused( button )
{
	...
	if (GetModeNameForEnum(level.ui.privatematch_mode) == "campaign_carousel") {
		...
		local customDescriptions = {
			...
			mp_nexus = "IMC forces preform a routine search at a backwater agricultural outpost that is suspected of harboring Militia personnel. Unbeknownst to them, this planet is the Frontier Militia's base of operations.",
			...
			mp_outpost_207 = "Orbital defense cannons are stationed at high altitude to defend against incursions from hostile capital ships. This outpost is responsible defending an IMC shipyard in the Freeport system.",
			...
			mp_haven = "This luxury retreat for the wealthy was built on the edge of a massive crater lake. Many of its frequenters have stocks in defense contracting and are interested in seeing the Frontier's war continue.",
			...
			mp_harmony_mines = "Energy-rich ores are extracted at this small industrial mining facility, located on the planet Harmony. Graphite and tungsten carbide are instrumental for Titan production.",
			mp_corporate = "Applied Robotics labs on the Frontier, such as this one, developed the first automated infantry 'Spectre' units. Hammond Robotics is an IMC Premier Technology Company (TM), though many secrets are still hidden under NDAs.",
			...
			mp_npe = "Simulation Training Pods are commonly used for Pilot certification, though many have been cracked and distributed by criminal organizations. Remember, piracy is a crime."
		}
