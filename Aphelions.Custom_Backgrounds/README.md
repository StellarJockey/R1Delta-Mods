...
* You'll see a bunch of folders called 'common', 'menu_imc', 'menu_demeter', etc... The 'common' folder controls what displays in game.
* To change it, simply copy and paste both .vtf files from your desired folder into 'common'. It's a bit inconvenient, but it works for now.
